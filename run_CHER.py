...
def arg_parse():
    ...
    parser.add_argument('--logfile', dest='logfile', type=str, default='train_CHER_form3.log',
                        help='Logging file')
    ...
    parser.add_argument('--save_model', dest='save_model', type=str, default='CHER_sample_form3',
...
try:
    for epoch in range(1):
        for ep in range(NUM_EP):
            ...
            if (ep==0) or (replay.size > batch_size*m_size):
                if (ep==0):
                    batch_size1 = 5
                    batch_size2 = 5
                for stps in range(K_size):
                    ...
                    for i in range(batch_size2-1):
                        ...
                        mini_s1.append(n_s1)
                        mini_a1.append(s_embs[index])
                    s, actual_action_embed, r1, s1, s_embs, actual_action, achi_g, pro, div = replay.sample_batch(batch_size1)
