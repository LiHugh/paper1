...
class NetworkEnv2(object):
    ...
    def __init__(self, fullGraph, seeds=[], max_T=100, influence_algo=influence, opt_reward=None, nop_r=0, times_mean=1,
                 bad_reward=0, normalize=False, clip_min=None, clip_max=None, budget=None):
    ...
    def goal_setting2(self, budget, num_query):
        for i in range(budget):
            query_node = list(self.possible_actions)
