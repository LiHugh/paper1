...
from test_env_net_delete2 import NetworkEnv
...
acmodel = torch.load('model_test/sample_2100.pth')
syn = False
ratio = 5
...
def arg_parse():
    ...
    parser.add_argument('--logfile', dest='logfile', type=str, default='test_RL_900.log',
                        help='Logging file')
    ...
    for epoch in range(1):
        for ep in range(100):
            ...
            for stps in range(budget):
                ...
                if d:
                    break
            final_num_infls.append(final_num_infl)
            ...
            rws.append(tot_r)
            print('###############################################final influenced number of nodes:', num_infl)
            print('!!!!!!!!!!!!!!!!!!!!!!!!final influenced number of nodes:', final_num_infls)
