...
try:
    for epoch in range(1):
        for ep in range(NUM_EP):
            ...
            # print('goal setting')
            # # final_goal = goal_env.goal_setting(1)
            # final_goal = goal_env.goal_setting2(budget, budget - 3)
            # # print(len(goal_env.state))
            # # print('final goal setting is:', final_goal)
            # final_goal = goal_env.goal_setting3(budget, budget - 3, 3)
            # # print('3 times final goal setting is:', final_goal)
            # final_goal = goal_env.goal_setting3(budget, budget - 3, 4)
            # print('4 times final goal setting is:', final_goal)
            final_goal = goal_env.goal_setting3(budget, budget-2, 3)
            final_goal = int(final_goal)
            # print('5 times final goal setting is:', final_goal)
            ...
            logging.info('Episode: ' + str(ep) + 'Number of n_g achieved: ' + str(n_g) + 'number:' + str(final_num_infl))
            ...
            rws.append(tot_r)
            # print('###############################################final influenced number of nodes:', num_infl, n_g, final_num_infl)
            # plot
            # ax.relim()
            # ax.autoscale_view()
            # ax2.relim()
